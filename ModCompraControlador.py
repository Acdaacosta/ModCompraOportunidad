...
class ModCompraControlador:
    ...
    def main(self):
        ...
        inv_min, inv_max, precio_nal, precio_imp, inv_ini, costo_uni_inv_ini, archivo_csv,Cap_compra_nal,Cap_compra_imp = vista.mostrar_formulario()
        ...
        if archivo_csv is not None:
            ...
            if st.button('Optimizar'):
                ...
                resultados, total_cost, status = Modelo.optimizar(lN, inv_min, inv_max, precio_nal, precio_imp, inv_ini, costo_uni_inv_ini, edited_df,Cap_compra_nal,Cap_compra_imp )
